...
#define ABOUT_SYSLINK_PROJECT_LINK _T("http://jacquelin.potier.free.fr/StaticImportFinder/")
#define ABOUT_SYSLINK_PROJECT_USER_DOC_LINK _T("http://jacquelin.potier.free.fr/StaticImportFinder/index.php#documentation_user")
