...
// You just need to edit this file to add new fake asm func 
// WARNING YOUR FAKE ASM FUNCTION MUST HAVE THE SAME PARAMETERS AND CALLING CONVENTION AS THE REAL ONE,
//                  ELSE YOU WILL GET STACK ERRORS

///////////////////////////////////////////////////////////////////////////////
// fake ASM function prototype MUST HAVE THE SAME PARAMETERS 
// your fake asm sources are in .asm file (like MasmSub.asm)
///////////////////////////////////////////////////////////////////////////////
extern "C" void mRotateRegisters();
