...
#define ABOUT_SYSLINK_PROJECT_LINK _T("http://jacquelin.potier.free.fr/winapioverride32/")
#define ABOUT_SYSLINK_PROJECT_USER_DOC_LINK _T("http://jacquelin.potier.free.fr/winapioverride32/documentation.php")
